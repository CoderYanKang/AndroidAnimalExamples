...
import com.yankang.androidanimexamples.AppCompatTransition.CustomTransitions.ColorTransition;
import com.yankang.androidanimexamples.AppCompatTransition.CustomTransitions.ProgressTransition;
...
public class CustomTransitionFragment extends Fragment {
    ...
    public void controlProgressBar(View view)
    {
        ...
        TransitionManager.beginDelayedTransition(container2 , progressTransition);
        switch (view.getId())
        {
            case R.id.add:
